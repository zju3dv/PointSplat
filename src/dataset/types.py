...
class BatchedViews(TypedDict, total=False):
    ...
    mask: Float[Tensor, "batch _ _ _ _"]  # batch view channel height width (optional)
    depth: Float[Tensor, "batch _ _ _"]  # batch view height width (optional)
...
class UnbatchedViews(TypedDict, total=False):
    ...
    mask: Float[Tensor, "_ _ height width"]  # view channel height width (optional)
    depth: Float[Tensor, "_ height width"]  # view height width (optional)
